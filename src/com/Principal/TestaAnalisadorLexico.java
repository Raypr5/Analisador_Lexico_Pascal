...
public class TestaAnalisadorLexico {
  ...
  public static void main(String[] args)  {
    ...
    try {
	  ...
	  // nesse buffered, ele lê o arquivo txt, ele tem acesso agora a todas as linhas dele.

      analisadorLexico = new AnalisadorLexico( bufferedReader );
      // aqui no analisador, ele vai receber o buffered(que é o arquivo txt) e começar a ler ele

	  token = analisadorLexico.pegarProximoToken(); // aqui é o token
